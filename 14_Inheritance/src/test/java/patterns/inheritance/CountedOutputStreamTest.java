...
public class CountedOutputStreamTest extends BaseOutputStreamTest {
	...
	@Test
	public void testCounter3() throws IOException {
		cos.write("X");
		Assert.assertEquals(
				"wrong counter result when writing \"X\" with method write(String)",
				1, cos.writtenChars());
	}

	@Test
	public void testCounter4() throws IOException {
		cos.write('X');
		Assert.assertEquals(
				"wrong counter result when writing \"X\" with method write(char)",
				1, cos.writtenChars());
	}

	@Test
	public void testCounter5() throws IOException {
		cos.write("Hi");
		cos.write("Hello");
		Assert.assertEquals(
				"wrong counter result when first writing \"Hi\" then \"Hello\" with method write(String)",
				7, cos.writtenChars());
	}
}
